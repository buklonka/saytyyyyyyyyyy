...
<div class="container">
    <section class="hero">
        <div class="hero-banner-container">
            <img src="/banner.png" alt="Промо-баннер <?php echo $site_config['casino_name']; ?>">
            <div class="hero-banner-promo-overlay" onclick="copyPromo()"><?php echo $site_config['promo_code']; ?></div>
        </div>
    </section>
    <section>
        <div style="display: flex; align-items: center; gap: 15px;">
            <img src="/reviews-icon.png" alt="Иконка казино">
    ...
    <section>
        <div style="display: flex; align-items: center; gap: 15px;">
            <img src="/bonus-icon.png" alt="Иконка бонусов">
    ...
    <section>
        <div style="display: flex; align-items: center; gap: 15px;">
            <img src="/promocode-icon.png" alt="Иконка промокодов">
    ...
    <section>
        <div style="display: flex; align-items: center; gap: 15px;">
            <img src="/mirror-icon.png" alt="Иконка зеркала">
    ...
    <section>
        <div style="display: flex; align-items: center; gap: 15px;">
            <img src="/app-icon.png" alt="Иконка приложения">
    ...
    <section>
        <div style="display: flex; align-items: center; gap: 15px;">
            <img src="/reviews-icon.png" alt="Иконка отзывов">
    ...
    <section>
        <div style="display: flex; align-items: center; gap: 15px;">
            <img src="/payments-icon.png" alt="Иконка платежей">
