...
<div class="container">
    <section class="hero" style="padding-top: 2rem; padding-bottom: 2rem; border-bottom: 1px solid var(--border-color);">
        ...
        <h1>Казино <?php echo $site_config['casino_name']; ?>: Стоит ли играть? Честный обзор и отзывы</h1>
    ...
    <section>
        <div style="display: flex; align-items: center; gap: 15px;">
            <img src="https://placehold.co/80x80/1A1A1A/00FFD1?text=★" alt="Иконка казино" style="border-radius: 8px;">
    ...
    <section>
        <div style="display: flex; align-items: center; gap: 15px;">
            <img src="https://placehold.co/80x80/1A1A1A/00FFD1?text=🎁" alt="Иконка бонусов" style="border-radius: 8px;">
    ...
    <section>
        <div style="display: flex; align-items: center; gap: 15px;">
            <img src="https://placehold.co/80x80/1A1A1A/00FFD1?text=💎" alt="Иконка промокодов" style="border-radius: 8px;">
    ...
    <section>
        <div style="display: flex; align-items: center; gap: 15px;">
            <img src="https://placehold.co/80x80/1A1A1A/00FFD1?text=🌐" alt="Иконка зеркала" style="border-radius: 8px;">
    ...
    <section>
        <div style="display: flex; align-items: center; gap: 15px;">
            <img src="https://placehold.co/80x80/1A1A1A/00FFD1?text=📱" alt="Иконка приложения" style="border-radius: 8px;">
    ...
    <section>
        <div style="display: flex; align-items: center; gap: 15px;">
            <img src="https://placehold.co/80x80/1A1A1A/00FFD1?text=💬" alt="Иконка отзывов" style="border-radius: 8px;">
    ...
    <section>
        <div style="display: flex; align-items: center; gap: 15px;">
            <img src="https://placehold.co/80x80/1A1A1A/00FFD1?text=💳" alt="Иконка платежей" style="border-radius: 8px;">
